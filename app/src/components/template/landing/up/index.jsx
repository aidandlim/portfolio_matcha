...
const Up = () => {
	...
	return (
		<form name='signup' onSubmit={_handleForm}>
			...
			{ /* Step 0 */ }
			<label className={ step === 0 ? 'landing-in-label' : 'landing-in-label unactive' }>
				<span>Email</span>
				<input className='landing-in-input' type='email' name='email' />
			</label>
			<label className={ step === 0 ? 'landing-in-label' : 'landing-in-label unactive' }>
				<span>Password</span>
				<input className='landing-in-input' type='password' name='password' />
			</label>
			<label className={ step === 0 ? 'landing-in-label' : 'landing-in-label unactive' }>
				<span>Confirm Password</span>
				<input className='landing-in-input' type='password' name='confirm' />
			</label>
			{ /* Step 1 */ }
			<label className={ step === 1 ? 'landing-in-label' : 'landing-in-label unactive' }>
				<span>First Name</span>
				<input className='landing-in-input' type='text' name='firstName' />
			</label>
			<label className={ step === 1 ? 'landing-in-label' : 'landing-in-label unactive' }>
				<span>Last Name</span>
				<input className='landing-in-input' type='text' name='lastName' />
			</label>
			<label className={ step === 1 ? 'landing-in-label' : 'landing-in-label unactive' }>
				<span>Birth Year</span>
				<select className='landing-in-input' name='birthYear'>
			...
			{ /* Step 2 */ }
			<label className={ step === 2 ? 'landing-in-label' : 'landing-in-label unactive' }>
				<span>Gender</span>
				<select className='landing-in-input' name='gender'>
			...
			<label className={ step === 2 ? 'landing-in-label' : 'landing-in-label unactive' }>
				...
				<select className='landing-in-input' name='preference'>
					<option value='0'>Male</option>
					<option value='1'>Female</option>
				</select>
			</label>
			<label className={ step === 2 ? 'landing-in-label' : 'landing-in-label unactive' }>
				<span>Bio</span>
				<textarea className='landing-in-textarea' name='bio'></textarea>
			</label>
			<input className={ step !== 2 ? 'landing-in-submit' : 'landing-in-submit unactive' } type='button' value='NEXT' onClick={ () => _handleCheckValidation() } />
			<input className={ step === 2 ? 'landing-in-submit' : 'landing-in-submit unactive' } type='submit' value='SUBMIT' />
