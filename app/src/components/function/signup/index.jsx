...
const Signup = () => {
	...
	return (
		<form name='signup' onSubmit={_handleForm}>
			...
			<input className='signin-input' type='text' name='firstName' placeholder='firstName' required />
			<input className='signin-input' type='text' name='lastName' placeholder='lastName' required />
			<select className='signin-input' name='birthYear' placeholder='birthYear'>
			...
			<select className='signin-input' name='gender' placeholder='gender'>
				<option value='0'>Male</option>
				<option value='1'>Female</option>
			</select>
			<select className='signin-input' name='preference' placeholder='preference'>
				<option value='0'>Male</option>
				<option value='1'>Female</option>
			</select>
